    ...
    <ContentViewer title="Reset Password">
      <View style={styles.container}>
        <InputField
          ...
          setVal={(val: string) => setPasswords({...passwords, currentPassword: val})}
        ...
        <InputField
          ...
          setVal={(val: string) => setPasswords({...passwords, newPassword: val})}
          secureTextEntry={true}
        />
        <InputField
          ...
          setVal={(val: string) => setPasswords({...passwords, confirmPassword: val})}
          secureTextEntry={true}
        />
      </View>
      <View>
